...
public class TaskerPlugin {
	 ...
	 *	@see net.dinglisch.android.tasker.TaskerPlugin.Host#getVariablesBundle(android.os.Bundle)
	 */
	...
	/**
     *  @see net.dinglisch.android.tasker.TaskerPlugin.Setting#hostSupportsVariableReturn(android.os.Bundle)
     */
	public final static int			EXTRA_HOST_CAPABILITY_SETTING_RETURN_VARIABLES = 2;
	
	/**
     *	@see net.dinglisch.android.tasker.TaskerPlugin.Condition#hostSupportsVariableReturn(android.os.Bundle)
     */
	public final static int			EXTRA_HOST_CAPABILITY_CONDITION_RETURN_VARIABLES = 4;

	/**
     * 	@see net.dinglisch.android.tasker.TaskerPlugin.Setting#hostSupportsOnFireVariableReplacement(android.os.Bundle)
     */
	...
	*/
	...
	public static class Setting {
         ...
         *  @see net.dinglisch.android.tasker.TaskerPlugin.Host#addCompletionIntent(android.content.Intent, android.content.Intent)
         */
        private final static String EXTRA_PLUGIN_COMPLETION_INTENT = EXTRAS_PREFIX + "COMPLETION_INTENT";

		/**
         *  @see #signalFinish(android.content.Context, android.content.Intent, int, android.os.Bundle)
         *  @see net.dinglisch.android.tasker.TaskerPlugin.Host#getSettingResultCode(android.content.Intent)
         */
