...
/**
 * If the user tries to launch the plug-in via the "Open" button in Google Play, this will redirect
 * the user to Locale or Tasker.
 */
            ...
            try {
                startActivity(new Intent(
                        ...
                        Uri.parse(String.format(Locale.US,
                                APP_STORE_URI,
                                "com.twofortyfouram.locale", getPackageName())))
